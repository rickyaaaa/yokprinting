            ...
            <div class="min-w-0 flex-1">
                ...
                >
                    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                        ...
                        <a href="{{ route('supplier-prices.index') }}" class="inline-flex w-fit items-center gap-2 rounded-lg border border-line bg-white px-3.5 py-2 text-sm font-semibold text-ink hover:bg-brand-50 hover:text-brand-800">
                    ...
                    <div x-show="loadingOptions" class="mb-4 rounded-xl border border-line bg-white p-4 text-sm text-muted">Memuat data supplier dan produk...</div>
