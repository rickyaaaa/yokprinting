        ...
        <div class="min-h-screen lg:flex" x-data="{ sidebarOpen: false }" @keydown.escape.window="sidebarOpen = false">
            ...
            <div class="min-w-0 flex-1">
                ...
                >
                    ...
                    <div x-show="loading" class="rounded-xl border border-line bg-white p-4 text-sm text-muted">Memuat data PO...</div>
                    ...
                    <form x-show="!loading && purchaseOrder" class="space-y-6" @submit.prevent="submit()">
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-4 py-3">
                                                    <div class="flex items-center gap-2">
                                                        ...
                                                        <button type="button" class="whitespace-nowrap rounded-lg border border-line px-2.5 py-1.5 text-xs font-semibold text-muted hover:bg-canvas" @click="fillMax(index)">Isi penuh</button>
                                                    </div>
                        ...
                        <button
                            type="submit"
                            class="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-brand-700 px-4 py-2.5 text-sm font-semibold text-white hover:bg-brand-800 disabled:cursor-wait disabled:opacity-60 sm:w-auto"
